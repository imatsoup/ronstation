...
/// </remarks>
public sealed class VentCrittersInvasionRule : StationEventSystem<VentCrittersInvasionRuleComponent>
{
    /*
    ...
    protected override void Added(EntityUid uid, VentCrittersInvasionRuleComponent comp, GameRuleComponent gameRule, GameRuleAddedEvent args)
    {
        PickLocation(comp);
    ...
    protected override void Ended(EntityUid uid, VentCrittersInvasionRuleComponent comp, GameRuleComponent gameRule, GameRuleEndedEvent args)
    {
    ...
    private void PickLocation(VentCrittersInvasionRuleComponent comp)
    {
